...
import { fetchMyQuizMeta } from "../utils/quiz-svc-client";
import {
...
import { toClassStudent } from "../utils/student-utils";
 ...
 *         - Enriches subjects with colorHex using quiz-svc `/quiz/meta`, with schedule/live meta fallback.
 * @logic  1) Load class roster with populated stats (scoped by classId).
 *         2) Find the target student and compute derived fields + rank.
 ...
 *     participationPct, avgScorePct, streakDays, overallScore, rank,
 *     stats: {
 *       ...,
 *       bySubject: { [subject]: { attempts, sumMax, sumScore, color? } },
 *       subjectColors: { [subject]: "#RRGGBB" },
 *       subjectsAvgPct, topicsAvgPct
 *     }
 *   }
 * }
 * @errors  404 class or student not found
